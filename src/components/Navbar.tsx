  ...
  return (
    <nav className="flex justify-between items-center px-6 py-4 bg-white w-full">
      ...
      <ul className="hidden md:flex space-x-8 mr-4">
        <li className="mt-2.5">
          <NavLink to="/" className="text-base font-normal text-gray-500 duration-300 hover:text-indigo-500 hover:font-bold">
            Flights
          </NavLink>
        </li>
        <li className="mt-2.5">
        ...
        <li className="bg-indigo-500 px-6 py-3 rounded-md cursor-pointer duration-300 hover:scale-101">
      ...
      >
        <ul className="flex flex-col space-y-4 px-6 py-4 text-center">
          ...
          <li className="bg-indigo-500 px-6 py-3 rounded-md cursor-pointer duration-300 hover:scale-101 text-center w-1/3 mx-auto">
            <NavLink to="/" className="text-base font-medium text-white">
              Sign up
            </NavLink>
          </li>
